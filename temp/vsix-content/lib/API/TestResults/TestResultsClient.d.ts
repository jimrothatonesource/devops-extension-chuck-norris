...
export declare class TestResultsRestClient extends RestClientBase {
     ...
     * @param key -
     */
    getAfdTcmEndpoint(key: string): Promise<string>;
    /**
     ...
     */
    getBranchesByFlakyTestCaseRefId(project: string, testCaseReferenceId: number): Promise<Test.TestCaseFlakinessBranchInfo>;
    /**
     * @param filter -
     * @param project - Project ID or project name
     */
     ...
     * @param workItemId -
     */
    generateTestPlanFromWorkItem(generateTestPlanFromWorkItemModel: Test.GenerateTestPlanFromWorkItemModel, project: string, workItemId: number): Promise<boolean>;
    /**
     ...
     */
    getTestWeightedScoreByBuild(project: string, buildId: number, includeAllOutcomes?: boolean, onlyFlakyResults?: boolean): Promise<Test.TestCaseResult[]>;
    /**
