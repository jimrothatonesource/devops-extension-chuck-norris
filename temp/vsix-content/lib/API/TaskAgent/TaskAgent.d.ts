...
export declare enum StageTriggerType {
    /**
...
export interface TaskInputDefinition extends DistributedTaskCommon.TaskInputDefinitionBase {
}
 ...
 */
export declare enum YamlCheckType {
    /**
