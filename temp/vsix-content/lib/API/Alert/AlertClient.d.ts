...
export declare class AlertRestClient extends RestClientBase {
     ...
     */
    getAlerts(project: string, repository: string, top?: number, orderBy?: string, criteria?: Alert.SearchCriteria, expand?: Alert.AlertListExpandOption, continuationToken?: string): Promise<WebApi.PagedList<Alert.Alert>>;
    /**
     * Get an alert.
     *
     * @param project - Project ID or project name
     ...
     * @param ref -
     */
    createLegalReview(project: string, repository: string, alertId: number, ref?: string): Promise<Alert.LegalReview>;
    /**
     ...
     */
    getOrgLevelAlertsByIds(alertIds: number[]): Promise<Alert.Alert[]>;
    /**
     ...
     */
    uploadSarif(content: string, project: string, repository: string, notificationFlag?: String): Promise<number>;
    /**
     ...
     * @param content - Content to upload
     */
    uploadOrgSarif(content: string): Promise<number>;
    /**
     ...
     * @param alertId - The ID of the alert
     */
    getValidityData(project: string, repository: string, alertId: number): Promise<Alert.ValidationRequestInfo>;
    /**
     ...
     * @param alertId - The ID of the alert
     */
    initiateValidation(project: string, repository: string, alertId: number): Promise<Alert.AlertValidationRequestStatus>;
}
